...
actual fun createSettings(): Settings {
    ...
    return SharedPreferencesSettings(context.getSharedPreferences("clearmind_preferences", Context.MODE_PRIVATE))
}

private val secretSettings by lazy {
    ResilientSecretSettings(runCatching { createEncryptedSettings(AppContext.applicationContext) }.getOrNull(), runCatching { createSettings() }.getOrNull())
}
