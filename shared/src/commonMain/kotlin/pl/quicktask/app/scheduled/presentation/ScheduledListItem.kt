...
@Composable
internal fun ScheduledListItem(
    item: ScheduledTask,
    onClick: () -> Unit,
    onEdit: () -> Unit,
    ...
    Card(
        ...
        Row(
            ...
            Column(
                ...
                item.recurrence?.let { rule ->
                    Text(recurrenceSummary(rule), style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.primary)
                }
                ...
                if (item.project != null || item.dueAt != null || item.contexts.isNotEmpty() || item.tags.isNotEmpty()) {
